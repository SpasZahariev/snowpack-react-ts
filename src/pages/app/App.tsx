      ...
      <div className="flex justify-center flex-col mx-auto px-2 md:px-32 lg:px-44 xl:px-56">
        <div className="bg-base z-0">
          ...
          <section ref={homeRef} className="py-12 px-4">
            ...
            <h2 className="font-sans text-pink text-4xl mt-2 mb-2 font-bold">Spas Zahariev</h2>
          </section>
          ...
          <section ref={aboutRef} className="py-12 px-4">
            <FadeInSection isVisible={isAboutVisible} handleVisualise={handleVisualizeAboutPermanently}>
              <p className="text-subtext0 leading-relaxed mb-4 max-w-2xl">
                I'm an engineering graduate from the <b className="text-flamingo">University of Southampton</b> and my main strength is writing Java backend.
                At the moment I am a fullstack software engineer at <b className="text-flamingo">JPMorgan Chase</b> where I've help my team build and maintain applications for tracking account liquidity.
              </p>
              <p className="text-subtext0 leading-relaxed mb-4 max-w-2xl">
              ...
              <FadeInSection isVisible={isExperienceVisible} handleVisualise={handleVisualizeExperiencePermanently}>
                ...
                {[
                  ...
                  <div key={job.company + job.role} className={`flex justify-between ${index !== arr.length - 1 ? 'mb-8' : ''}`}>
                    <div className="grid">
                      <span className="text-flamingo font-semibold">{job.company}</span>
              ...
              <FadeInSection isVisible={isCertsVisible} handleVisualise={handleVisualizeCertsPermanently}>
                ...
                {[
                  ...
                  <div key={cert.name} className={`flex justify-between items-center ${index !== arr.length - 1 ? 'mb-5' : ''}`}>
                    <div className="text-flamingo font-semibold">{cert.name}</div>
            ...
            <FadeInSection isVisible={isSkillsVisible} handleVisualise={handleVisualizeSkillsPermanently}>
              ...
              <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(270px,1fr))]">
                <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(120px,0.5fr))]">
                  <div>
                    <p className="text-xl text-flamingo font-semibold mb-1">Languages</p>
                  ...
                  <div>
                    <p className="text-xl text-flamingo font-semibold mb-1">Technologies</p>
                    <ul className="list-none p-0 text-subtext1">
                ...
                <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(120px,0.5fr))]">
                  <div>
                    <p className="text-xl text-flamingo font-semibold mb-1">Services</p>
                    <ul className="list-none p-0 text-subtext1">
                  ...
                  <div>
                    <p className="text-xl text-flamingo font-semibold mb-1">Other</p>
                    <ul className="list-none p-0 text-subtext1">
          ...
          <section ref={contactRef} className="py-12 px-4 text-center">
            ...
            <p className="mt-4 text-subtext0">
              Feel free to reach out via: <b className="text-flamingo">
                <a href="mailto:spas.zah@gmail.com" className="no-underline text-pink hover:text-mauve">
                  spas.zah@gmail.com
                </a>
              </b>
            </p>
            <p className="text-subtext0">UK mobile: <b className="text-flamingo">07784239930</b></p>
